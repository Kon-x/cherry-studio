---
description: OTel tracing for chat calls — Cherry roots, AI SDK spans, local projection, and sinks
sources:
...
The container `traceId` is persisted on the topic row (one trace
