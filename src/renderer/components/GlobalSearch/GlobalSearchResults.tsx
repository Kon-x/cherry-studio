...
import { ArrowRight, ChevronDown, Clock3, FileSearch, MessageSquare, Sparkles } from 'lucide-react'
...
export function GlobalSearchRow({
  ...
  const emoji = !isRecent && ['assistant', 'knowledge-base'].includes(item.result.type) ? item.result.emoji : undefined
