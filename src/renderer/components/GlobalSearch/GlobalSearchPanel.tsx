...
const SEARCH_FILTERS: Exclude<GlobalSearchFilter, 'all'>[] = ['topic', 'assistant', 'knowledge']
...
type GlobalSearchMessageJumpTarget = { sourceType: 'topic'; topicId: string; messageId: string }
