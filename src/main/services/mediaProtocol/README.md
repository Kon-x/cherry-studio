...
| `registerSchemes.ts` | `CHERRY_MEDIA_SCHEME_DECLARATION` — the pre-ready privilege declaration; `main.ts` passes it to the process's single `registerSchemesAsPrivileged` call  |
